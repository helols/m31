...
public class OpenApiRequestHelperTest {
    ...
    public void docElementValueToMap() throws Exception {
        ...
        Assert.assertThat(OpenApiRequestHelper.docElementValueToMap(doc,false).toString().substring(0,100),is(makeString.substring(0,100)));
        Assert.assertThat(OpenApiRequestHelper.docElementValueToMap(me2Doc,true).get("url").toString(), is("http://me2day.net/api/auth?token=32805ce5290f4f0555eabbdfbe99f73e"));
    }
