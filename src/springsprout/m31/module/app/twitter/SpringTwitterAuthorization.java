...
public class SpringTwitterAuthorization {
	...
	@Autowired SpringTwitterRepository twitterRepository;
	...
	public Boolean checkAuthorization(SecurityService securityService) throws TwitterException {
		String userToken;
	...
	public String getAuthorizationURL(SecurityService securityService) throws TwitterException {
...
//		String userSecretToken = "P0sILcVd5ERJpeiIeJQrXAEmIQ7mqggC5134ATIM";
	...
	public void getAuthorization(SecurityService securityService) throws TwitterException {
//		String userToken;
//		String userSecretToken;
...
//	    }
	...
	public Boolean storeAuthToken(String oauthToken, SecurityService securityService) throws TwitterException {
		Twitter twitter = new Twitter();
		twitter.setOAuthConsumer(CONSUMER_KEY, CONSUMER_SECRET);
