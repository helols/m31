...
public class OpenApiRequestHelperTest {
    ...
    public void docElementValueToMap() throws Exception {
        ...
        String me2Url = "http://me2day.net/api/get_auth_url?akey=eb4d74485df2773948ccd8eefdd53ef3";
        String duamUrl = "http://apis.daum.net/search/image?q=yuna&apikey=d15e82f0b108d06e45ec70a9f7eec3aac3c0c61c&output=rss";
        ...
        Document me2Doc = loadXml(me2Url);
        Document daumUrlDoc = loadXml(duamUrl);
        Assert.assertThat(OpenApiRequestHelper.docElementValueToMap(doc,false).toString(),is(notNullValue()));
        Assert.assertThat(OpenApiRequestHelper.docElementValueToMap(me2Doc,true).get("url").toString(), is(notNullValue()));
        System.out.println(OpenApiRequestHelper.docElementValueToMap(daumUrlDoc,false));
    }
    ...
    public void docAttributeValueToMap() throws Exception {
        ...
        Assert.assertThat(
                ((ArrayList < HashMap <String, String>>)OpenApiRequestHelper.docAttributeValueToMap(doc,false).get("forecast_information"))
